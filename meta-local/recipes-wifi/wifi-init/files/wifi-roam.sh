...
# ----------------------------------------------------------------------
# In conf:
#   Wifi_Net_5G  priority=20
#   Wifi_Net     priority=10
...
#   - prefer Wifi_Net_5G when it is good enough;
#   - on weak 5G, force Wifi_Net (2.4);
...
IFACE="${IFACE:-wlan0}"
SSID_5G="${SSID_5G:-Wifi_Net_5G}"
SSID_24="${SSID_24:-Wifi_Net}"
...
nid_by_ssid() {
	# list_networks: id \t ssid \t ... — SSID may contain spaces (Wifi_Net).
