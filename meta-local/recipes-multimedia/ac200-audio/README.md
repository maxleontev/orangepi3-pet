...
| Mixer defaults | `files/ac200-mic-setup.sh` — ADC Volume **7**, Master cap **62%**, MIC1 Boost **4**. Waits until `amixer` can open card `ac200audio` (boot used to hit `Invalid card number '0'` and leave capture off).
