...
tools (amixer, arecord, aplay). Kernel driver, DTS and audio.cfg live in \
ac200-audio-kernel.inc (included from linux-mainline). \
Driver defaults are too quiet or clip; see files/ac200-mic-setup.sh."
LICENSE = "MIT"
